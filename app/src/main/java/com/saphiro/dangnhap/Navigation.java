...
public class Navigation extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headerUser = (TextView) navigationView.getHeaderView(0).findViewById(R.id.headerUsername);
        ...
        String user = sharedPreferences.getString("UserID", "").replaceAll("[0-9]", "")
                .toUpperCase();

        String email = sharedPreferences.getString("Email", "");
        headerUser.setText(user);
        headerEmail.setText(email);
        welcomeUser.setText(getString(R.string.welcome, user));
